...
const sumedAreaTableBase = (tSrc, passesPerAxis = 2, squared = false) => {
 ...
 */
export const sat = (tSrc, passesPerAxis = 2) =>
  sumedAreaTableBase(tSrc, passesPerAxis, false);
 ...
 * @param {number} [passesPerAxis] - Performance configurator of passes/samplesPerPass
 */
export const sqsat = (tSrc, passesPerAxis = 2) =>
  sumedAreaTableBase(tSrc, passesPerAxis, true);
