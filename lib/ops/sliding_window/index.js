 ...
 * Copyright 2024 Peculiar Ventures.
 * All rights reserved.
 */
 ...
 *
 * @todo: Review description ([@worldthirteen](https://github.com/worldthirteen), [@apilguk](https://github.com/apilguk))
 * @todo: Review strategy API
 */

const slidingWindowOp = (tSrc, windowSize, stride = 1, strategy = 0) => {
