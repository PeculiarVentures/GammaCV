...
describe.only('HAAR Features', () => {
  ...
  it('test100', async () => {
    ...
    const f2 = gm.calcHAARFeature(out, feature2, 20, 65, 15, 20); // this value should be close to 0
    const f3 = gm.calcHAARFeature(out, feature3, 20, 15, 65, 20); // this value should be close to 0
  ...
  it('test200', async () => {
    ...
    const f2 = gm.calcHAARFeature(out, feature2, 40, 130, 30, 20); // this value should be close to 0
    const f3 = gm.calcHAARFeature(out, feature3, 40, 30, 130, 20); // this value should be close to 0
  ...
  it('test300', async () => {
    ...
    const f2 = gm.calcHAARFeature(out, feature2, 60, 195, 45, 20); // this value should be close to 0
    const f3 = gm.calcHAARFeature(out, feature3, 60, 45, 195, 20); // this value should be close to 0
