...
describe.only('Convolution', () => {
  ...
  it('Identity kernel with factor and bias', async () => {
    const input = new gm.Tensor('float32', [3, 3, 4], new Float32Array(arrayToTexture([
      1, 2, 3,
      4, 5, 6,
      7, 8, 9,
    ])));
    ...
    const predictedOutput = new gm.Tensor('float32', [3, 3, 4], new Float32Array(arrayToTexture([
      0.8, 1.3, 1.8,
      2.3, 2.8, 3.3,
      3.8, 4.3, 4.8,
    ], 1)));
  ...
  describe('buitin kernels', () => {
    it('gaussianBlur', () => {
      const input = new gm.Tensor('uint8', [3, 3, 4], new Uint8Array(arrayToTexture([
        10, 20, 30,
        40, 50, 60,
        70, 80, 90,
      ])));
      ...
      const predictedOutput = new gm.Tensor('uint8', [3, 3, 4], new Uint8Array(arrayToTexture([
        21, 28, 35,
        43, 50, 57,
        65, 72, 79,
      ], 255)));
